...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.calcBtn = QtWidgets.QPushButton(self.centralwidget)        #### , clicked = lambda: self.calcTotal() )   ### cach 1 lien ket nut nhan
        ...
        # event
        self.calcBtn.clicked.connect(self.calcTotal)            #### cach 2 lien ket nut nhan
